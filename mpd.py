...
def concatenate_m3u8():
    ...
    urls = [
        ...
        "https://raw.githubusercontent.com/simud/simud/refs/heads/main/simudtrials.m3u8",
    ...
    try:
        with open("mpdott.m3u8", "w", encoding="utf-8") as f:
            f.write("\n".join(combined_content))
        print(f"File creato con successo: mpdott.m3u8 con {len(combined_content)} righe")
